...
export default function OrderDetail() {
  ...
  return (
    <div className="px-4 md:px-8 py-6 max-w-lg mx-auto">
      ...
      {order.paymentMethod === 'qr' && order.status === 'pending' && (
        <div className="mb-6">
          <p className="text-xs font-medium text-gray-600 mb-2">Complete payment</p>
          <KHQRPayment orderId={order.id} onPaid={refetch} />
        </div>
      )}
